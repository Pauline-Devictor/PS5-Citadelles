...
public class CsvWrite {
    public void write(String data){
        try {
            ...
            //close the writer
            writer.close();
        } catch (Exception e){System.out.println("error during writing");}
    }
    public void append(String data){
        ...
        writer.close();
    }catch (Exception e){System.out.println("error during append");}
    }
    public void save(){
        try {
        ...
        writer.close();
        } catch (Exception e){System.out.println("error during save");}
    }
}
